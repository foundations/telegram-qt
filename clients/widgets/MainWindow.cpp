...
MainWindow::MainWindow(QWidget *parent) :
    ...
    m_core(new Telegram::Client::Client(this)),
...
void MainWindow::setAppState(MainWindow::AppState newState)
{
        ...
        updateContactList();
    {
        ...
        //m_core->dataStorage()->getUserInfo(&selfInfo, m_core->selfId());
...
{
    quint32 userId = 0;//m_core->resolveUsername(m_searchQuery);
...
void MainWindow::on_deleteContact_clicked()
{
    ...
    //    m_core->dataStorage()->getUserInfo(&info, userId);
    //
...
void MainWindow::setActiveContact(quint32 userId)
{
    ...
    SContact userInfo;
    m_core->dataStorage()->getUserInfo(&userInfo, m_activeContactId);
...
void MainWindow::sendMedia(const Telegram::Peer peer)
{
    ...
    quint32 id = 0;//m_core->uploadFile(file.readAll(), info.fileName());
